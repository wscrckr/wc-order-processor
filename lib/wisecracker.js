...
wisecracker.checkShopifyCustomer = function checkShopifyCustomer(shopifyCustomer, cb) {
  ...
  xero.getContacts(whereFilter, function(apiGetBody) {
    if (apiGetBody.Contacts.length == 0) {
      ...
      wisecracker.addXeroContact(customerName, shopifyCustomer, cb);
    } else {
...
wisecracker.addXeroContact = function addXeroContact(customerName, shopifyCustomer, cb) {
...
wisecracker.addXeroInvoice = function addXeroInvoice(shopifyOrder, xeroContact, cb) {
